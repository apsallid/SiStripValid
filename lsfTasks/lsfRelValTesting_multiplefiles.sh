...
cmsDriver.py SingleMuPt100_cfi.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT:GRun -n 100 --eventcontent FEVTDEBUGHLT --conditions auto:mc --mc 
...
mv DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root RECO_SingleMuPt100_cfi_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_$1.root

rfcp RECO_SingleMuPt100_cfi_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_$1.root /castor/cern.ch/user/a/apsallid/CMS/ServiceWork/RelValTesting
