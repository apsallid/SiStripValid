...
customFile=DQMTools/Tests/test41.py

cmsDriver.py test_${tnum}_${step}_1 -s RAW2DIGI,RECO,${DQMSEQUENCE} -n ${numev} --processName=RERECO --eventcontent DQMROOT --datatier DQMROOT --conditions auto:com10 --data --filein 'file:/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/DQMTest/Skim_Run172791_173241_173243_173244.root' --customise ${customFile} --python_filename=test_${tnum}_${step}_new_Run172791_173241_173243_173244.py --no_exec --fileout file_${tnum}_${step}_new_Run172791_173241_173243_173244.root
