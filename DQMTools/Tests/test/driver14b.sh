...
cmsDriver.py step3_DT1_1 -s ${DQMSEQUENCE} --conditions auto:com10 --data --filein file:step2_DT1_1_RAW2DIGI_RECO_DQM.root --scenario pp --customise DQMTools/Tests/customHarvesting.py --no_exec
