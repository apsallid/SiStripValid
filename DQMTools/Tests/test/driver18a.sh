...
cmsDriver.py step_VALIDATION -s RAW2DIGI,RECO,VALIDATION -n ${numev} --filein file:SingleMuPt10_cfi_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root --eventcontent RECOSIM --conditions auto:mc --mc --customise DQMTools/Tests/customRecoSimIgProf.py --no_exec --python_filename test_validation_cfg.py
