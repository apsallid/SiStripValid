...
cmsDriver.py test_${TNUM}_${STEP}_1 --no_exec --scenario HeavyIons --conditions auto:starthi_HIon --mc -s ${DQMSEQUENCE} -n ${NUMEV} --filein file:test_${TNUM}_a_1.root --customise DQMTools/Tests/customHarvesting.py --python_filename=test_${TNUM}_${STEP}_1.py
