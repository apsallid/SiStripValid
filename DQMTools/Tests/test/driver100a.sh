...
cmsDriver.py test_${tnum}_${step}_2 -s RAW2DIGI,RECO,${DQMSEQUENCE} -n ${numev} --eventcontent DQM --datatier DQMROOT --conditions auto:com10  --filein file:/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/DQMTest/Cosmics__RAW__v1__147647__02958305-11D4-DF11-A231-0030487CD77E.root --data  --no_exec --python_filename=test_${tnum}_${step}_2.py 
...
cmsDriver.py test_${tnum}_${step}_3 -s RAW2DIGI,RECO,${DQMSEQUENCE} -n ${numev} --eventcontent DQM --datatier DQMROOT --conditions auto:com10  --filein file:/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/DQMTest/Cosmics__RAW__v1__147647__029F4350-10D4-DF11-A37D-0030487CD6DA.root --data  --no_exec --python_filename=test_${tnum}_${step}_3.py
