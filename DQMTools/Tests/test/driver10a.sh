...
cmsDriver.py step2_DT1_2 -s RAW2DIGI,RECO,${DQMSEQUENCE} -n ${NUMEV} --eventcontent RECO --conditions auto:craft09  --filein file:/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/DQMTest/Cosmics__RAW__v1__110998__002174A8-E989-DE11-8B4D-000423D6CA42.root --data --customise DQMTools/Tests/customReco.py --no_exec --python_filename=step${TNUM}_2.py
